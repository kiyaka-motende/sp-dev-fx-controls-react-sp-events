...
export var ControlsTestEnhancedThemeProviderFunctionComponent = function () {
    ...
    return (React.createElement(Stack, { tokens: { childrenGap: 10 } },
        ...
        React.createElement(Placeholder, { iconName: 'Edit', iconText: 'Configure your web part', description: 'Please configure the web part.', buttonLabel: 'Configure', onConfigure: function () { alert("onConfigure"); } }),
