    ...
    function ControlsTest(props) {
        ...
        */
        ...
        _this.getRandomCollectionFieldData = function () {
            var result = [];
            for (var i = 1; i < 16; i++) {
                result.push({ "Field1": "String".concat(i), "Field2": i, "Field3": "https://pnp.github.io/", "Field4": true });
            }
            return result;
        };
        _this.state = {
       ...
       */
        ...
        return (React.createElement("div", { className: styles.controlsTest },
            React.createElement("div", { className: "ms-font-m" },
                React.createElement(DynamicForm, { context: this.props.context, listId: "6D0FE1C6-87D8-4BF5-90FF-77C8C05D1574", listItemId: 116, onCancelled: function () { console.log('Cancelled'); }, onSubmitted: function (listItem) { return __awaiter(_this, void 0, void 0, function () { var itemdata; return __generator(this, function (_a) {
                        switch (_a.label) {
            ...
            React.createElement("div", { className: styles.container },
                React.createElement("div", { className: "ms-Grid-row ms-bgColor-neutralLight ms-fontColor-neutralDark ".concat(styles.row) },
            ...
            React.createElement("div", null,
                ...
                React.createElement(FilePicker, { bingAPIKey: "<BING API KEY>", webAbsoluteUrl: "https://aterentiev.sharepoint.com/sites/SPFxinTeamsDemo", defaultFolderAbsolutePath: "https://aterentiev.sharepoint.com/sites/SPFxinTeamsDemo/Shared%20Documents/General", 
            ...
            React.createElement("div", null,
                ...
                React.createElement(AdaptiveCardHost, { card: {
                    ...
                    }, theme: this.props.themeVariant, themeType: AdaptiveCardHostThemeType.SharePoint, onInvokeAction: function (action) { return alert(JSON.stringify(action)); }, onError: function (error) { return alert(error.message); }, onSetCustomElements: function (registry) { }, onSetCustomActions: function (registry) { }, onUpdateHostCapabilities: function (hostCapabilities) {
