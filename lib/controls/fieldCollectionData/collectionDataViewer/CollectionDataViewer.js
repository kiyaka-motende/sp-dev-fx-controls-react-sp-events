...
var CollectionDataViewer = /** @class */ (function (_super) {
    ...
    CollectionDataViewer.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            (!this.state.crntItems || this.state.crntItems.length === 0) && (React.createElement("p", { className: "FieldCollectionData__panel__no-collection-data ".concat(styles.noCollectionData) }, strings.CollectionDataEmptyValue)),
            React.createElement("div", { className: "FieldCollectionData__panel__actions ".concat(styles.panelActions) },
