...
var RichText = /** @class */ (function (_super) {
    ...
    RichText.prototype.render = function () {
        ...
        if (!isEditMode) {
            return (React.createElement("div", { className: "ql-editor ".concat(styles.richtext, " ").concat(this.props.className || ''), dangerouslySetInnerHTML: { __html: text } }));
        }
        // Okay, we're in edit mode.
        var _b = this.props, placeholder = _b.placeholder, _c = _b.styleOptions, showStyles = _c.showStyles, showBold = _c.showBold, showItalic = _c.showItalic, showUnderline = _c.showUnderline, showAlign = _c.showAlign, showList = _c.showList, showLink = _c.showLink, showMore = _c.showMore, showImage = _c.showImage;
        ...
        return (React.createElement("div", { ref: function (ref) { _this._wrapperRef = ref; }, className: "".concat(styles.richtext && this.state.editing ? 'ql-active' : '', " ").concat(this.props.className) },
            React.createElement("div", { id: this._toolbarId, style: { top: this.state.wrapperTop } },
                ...
                showLink && (React.createElement(TooltipHost, { content: strings.LinkTitle, id: "link-richtextbutton", calloutProps: { gapSpace: 0 } },
                    React.createElement(IconButton, { checked: ((_a = this.state.formats) === null || _a === void 0 ? void 0 : _a.link) !== undefined, onClick: this.showInsertLinkDialog, "aria-describedby": "link-richtextbutton", iconProps: {
                            iconName: 'Link'
                        } }))),
