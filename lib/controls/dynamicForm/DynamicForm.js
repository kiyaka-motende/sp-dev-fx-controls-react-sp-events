...
var DynamicForm = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        _loop_2 = function (i, len) {
                            var field, fieldType, hiddenName, termSetId, lookupListId, lookupField, choices_1, defaultValue, selectedTags_1, richText, dateFormat, principalType, recurrenceInfo, response, response, schemaXml, dateFormatRegEx, userEmails, _c, _d, _e;
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        field = responseValue[i];
                                        if (!(hiddenFields.indexOf(field.EntityPropertyName) < 0)) return [3 /*break*/, 35];
                                        order++;
                                    ...
                                    case 17:
                                        defaultDayOfWeek = (_f.sent()).FirstDayOfWeek;
                                        return [3 /*break*/, 34];
                                    case 18:
                                    ...
                                    case 26:
                                        ...
                                        return [3 /*break*/, 34];
                                    case 27:
                                        if (!(fieldType === "Location")) return [3 /*break*/, 28];
                                        defaultValue = JSON.parse(defaultValue);
                                        return [3 /*break*/, 34];
                                    case 28:
                                        if (!(fieldType === "Boolean")) return [3 /*break*/, 29];
                                        defaultValue = Boolean(Number(defaultValue));
                                        return [3 /*break*/, 34];
                                    case 29:
                                        if (!(fieldType === "AllDayEvent")) return [3 /*break*/, 30];
                                        defaultValue = Boolean(Number(defaultValue));
                                        return [3 /*break*/, 34];
                                    case 30:
                                        if (!(fieldType === "Recurrence")) return [3 /*break*/, 34];
                                        //capture all recurrence related data
                                        defaultValue = Boolean(Number(defaultValue));
                                        if (!(item.EventType === "4" && item.MasterSeriesItemID !== "")) return [3 /*break*/, 31];
                                        _e = item.RecurrenceData;
                                        return [3 /*break*/, 33];
                                    case 31: return [4 /*yield*/, this_2.returnExceptionRecurrenceInfo(item.RecurrenceData)];
                                    case 32:
                                        _e = _f.sent();
                                        _f.label = 33;
                                    case 33:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (contentTypeId !== undefined && contentTypeId !== '') {
                            apiUrl = "".concat(webAbsoluteUrl, "/_api/web/lists(@listId)/contenttypes('").concat(contentTypeId, "')/fields?&$select=RecurrenceData,*&@listId=guid'").concat(encodeURIComponent(listId), "'&$filter=ReadOnlyField eq false and Hidden eq false");
                        }
                        else {
                            apiUrl = "".concat(webAbsoluteUrl, "/_api/web/lists(@listId)/fields?&$select=RecurrenceData,*&@listId=guid'").concat(encodeURIComponent(listId), "'&$filter=ReadOnlyField eq false and Hidden eq false");
                        }
    ...
    DynamicForm.prototype.returnExceptionRecurrenceInfo = function (recurrenceData) {
