...
export function ModernTaxonomyPicker(props) {
    ...
    }, [currentTermStoreInfo === null || currentTermStoreInfo === void 0 ? void 0 : currentTermStoreInfo.defaultLanguageTag, props.anchorTermId, props.context.pageContext, props.initialValues, props.termSetId, taxonomyService]);
    React.useEffect(function () {
    ...
    function addParentInformationToTerms(filteredTerms) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, filteredTerms_1, filteredTerm, termParent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _i = 0, filteredTerms_1 = filteredTerms;
                        _a.label = 1;
                    case 1:
                        if (!(_i < filteredTerms_1.length)) return [3 /*break*/, 4];
                        filteredTerm = filteredTerms_1[_i];
                        return [4 /*yield*/, getParentTree(filteredTerm)];
                    case 2:
                        termParent = _a.sent();
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, filteredTerms];
                }
            });
        });
    }
    function onResolveSuggestions(filter, selectedItems) {
        return __awaiter(this, void 0, void 0, function () {
            var filteredTerms, filteredTermsWithParentInformation, _a, filteredTermsWithoutSelectedItems, filteredTermsAndAvailable;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (filter === '') {
                    ...
                    case 1:
                        ...
                        if (!props.isPathRendered) return [3 /*break*/, 3];
                        return [4 /*yield*/, addParentInformationToTerms(filteredTerms)];
                    case 2:
                        _a = _b.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        _b.label = 4;
                    case 4:
                        filteredTermsWithParentInformation = _a;
                        filteredTermsWithoutSelectedItems = filteredTermsWithParentInformation.filter(function (term) {
    ...
    function onRenderItem(itemProps) {
        ...
        return labels.length > 0 ? (React.createElement(TermItem, __assign({ languageTag: currentLanguageTag, termStoreInfo: currentTermStoreInfo }, itemProps), fullParentPrefixes.join(":"))) : null;
    }
