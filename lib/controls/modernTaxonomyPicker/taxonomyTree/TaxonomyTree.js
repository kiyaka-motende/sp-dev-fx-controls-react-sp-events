...
export function TaxonomyTree(props) {
    ...
    React.useEffect(function () {
        ...
        setGroups([rootGroup]);
        setGroupsLoading(function (prevGroupsLoading) { return __spreadArray(__spreadArray([], prevGroupsLoading, true), [props.termSetInfo.id], false); });
    ...
    var onToggleCollapse = function (group) {
        if (group.isCollapsed === true) {
            ...
            if (group.children && group.children.length === 0) {
                setGroupsLoading(function (prevGroupsLoading) { return __spreadArray(__spreadArray([], prevGroupsLoading, true), [group.key], false); });
        ...
        if ((footerProps.group.hasMoreData || footerProps.group.children && footerProps.group.children.length === 0) && !footerProps.group.isCollapsed) {
            ...
            return (React.createElement("div", { className: styles.loadMoreContainer },
                React.createElement(Link, { onClick: function () {
                        setGroupsLoading(function (prevGroupsLoading) { return __spreadArray(__spreadArray([], prevGroupsLoading, true), [footerProps.group.key], false); });
