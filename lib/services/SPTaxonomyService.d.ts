...
export declare class SPTaxonomyService {
    ...
    searchTerm(termSetId: Guid, label: string, languageTag: string, parentTermId?: Guid, allowSelectingChildren?: boolean, stringMatchId?: string, pageSize?: number): Promise<ITermInfo[]>;
