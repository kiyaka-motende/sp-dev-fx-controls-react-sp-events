...
var SPTaxonomyService = /** @class */ (function () {
    ...
    SPTaxonomyService.prototype.searchTerm = function (termSetId, label, languageTag, parentTermId, allowSelectingChildren, stringMatchId, pageSize) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        query = [
                            ...
                            "stringMatchId='".concat(stringMatchId, "'")
                        ];
